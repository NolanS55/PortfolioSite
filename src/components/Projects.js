...
{name : "MinMax Game Tree", summary : "Simple game tree made in python for playing basic python game", description : "A game tree that picks the best move in a game where the goal is to take as much space on a board as possible. I am hoping to take what I learned from coding this and make it into a chess engine soon.", source : "https://github.com/NolanS55/MinMax-Gametree", src : tree},
